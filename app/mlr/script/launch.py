...
#    , "test_file": join(app_dir, "datasets/covtype.scale.test.small")
    "train_file": "/home/wuhaonan/data/criteoKaggle300w/libsvmformat/train.libsvm_1"
    , "test_file": "/home/wuhaonan/data/criteoKaggle300w/libsvmformat/test.libsvm_2"
    , "global_data": "true"
    , "perform_test": "true"
    ...
    , "lr_decay_rate": 1 # lr = init_lr * (lr_decay_rate)^T
    , "num_batches_per_eval": 100000
...
petuum_params = { 
    "hostfile": "/home/wuhaonan/petuum/hostfile"
    , "num_app_threads": 24
    , "staleness": 0
